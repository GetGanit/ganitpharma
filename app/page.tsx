...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-hero-gradient text-slate-900 font-sans selection:bg-amber-400 selection:text-slate-950 overflow-hidden relative">
      ...
      {/* Top Banner */}
      <div className="bg-gradient-to-r from-amber-500 to-amber-400 text-slate-950 text-xs font-black py-2.5 px-4 text-center shadow-sm relative z-20 animate-fade-in">
      ...
      {/* Bottom CTA Banner */}
      <section className="bg-slate-950 text-white py-16 px-6 text-center space-y-6 relative z-10 border-t border-slate-800">
        ...
        <p className="text-xs text-slate-400 font-medium">Try the live demo pharmacies first, then buy once and use it for life.</p>
      ...
      {/* Footer */}
      <footer className="border-t border-slate-200/80 py-16 px-6 lg:px-16 bg-white/60 backdrop-blur-md relative z-10 text-xs text-slate-600">
        ...
        <div className="max-w-7xl mx-auto pt-12 mt-12 border-t border-slate-200/80 flex flex-col sm:flex-row justify-between items-center text-[11px] text-slate-400">
